...
import EditBranch from "../pages/Forms/BasicElements/EditBranch";


//Tables
import BasicTables from '../pages/Tables/BasicTables/BasicTables';
import BranchesRegistration from '../pages/Forms/BasicElements/BranchesRegistration';
import ListTables from '../pages/Tables/ListTables/ListTables';
import ReactTable from "../pages/Tables/ReactTables";
import BranchesTable from "../pages/Tables/BasicTables/BranchesTable";
...
const authProtectedRoutes = [
  ...
  {path:'/branch-reg', component: <BranchesRegistration></BranchesRegistration>},
  ...
  { path: "/branches-tables", component: <BranchesTable /> },
